...
> **Vendored from** [arbisoft/ai-skillforge](https://github.com/arbisoft/ai-skillforge/tree/main/Claude/skills/blueprint).
> The full `/blueprint` slash command ships with the upstream Everything Claude Code toolchain;
> this copy is kept as a methodology reference. ASH's PM agent and spec validator already apply
> its core ideas — acyclic dependency graphs, cold-start ticket briefs, and an adversarial/automated
> review gate. See [docs/best_practices.md](../../../docs/best_practices.md).
