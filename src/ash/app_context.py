...
This is the only place that wires concrete agents together. Tests can inject a fake GitHub client
and PM model to keep runs deterministic and offline.
"""
...
from ash.agents.pm import PMAgent, _BoardClient
...
def build_agents(
    ...
    *,
    ...
    return {
        "pm": PMAgent(settings, model=pm_model, github=github),
