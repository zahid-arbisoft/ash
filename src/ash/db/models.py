...
class RunRecord(Base):
    ...
    item_id: Mapped[str | None] = mapped_column(String(200), nullable=True, default=None)
    intake_mode: Mapped[str] = mapped_column(String(40))
    spec_file_path: Mapped[str | None] = mapped_column(String(500), nullable=True, default=None)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
